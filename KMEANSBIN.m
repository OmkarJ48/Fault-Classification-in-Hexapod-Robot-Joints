...
N = 50;  % Oversampling percentage (adjust as needed)
...
eva = evalclusters(balanced1bin,fh,"DaviesBouldin","KList",14:15);
clear fh
K = eva.OptimalK;
...
for K_idx = 1:length(K_values)
    ...
    currentClusterIndices = kmeans(balanced1bin, currentK, 'Distance', 'cityblock', 'Replicates', 20);
    
    % Compute VRC for the current clustering result
    VRC_values(K_idx) = computeVRC(balanced1bin, currentClusterIndices);
end
